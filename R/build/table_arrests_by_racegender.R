...
read_csv(here("C:/Users/Haokun Zhang/Desktop/UTexas classes/casual inference/Hidden curriculum/NLSY97_Hidden_Curriculum/R/data/NLSY97_clean.csv")) %>%
  ...
  write_lines(here("C:/Users/Haokun Zhang/Desktop/UTexas classes/casual inference/Hidden curriculum/NLSY97_Hidden_Curriculum/tables/arrests_by_racegender.tex"))
